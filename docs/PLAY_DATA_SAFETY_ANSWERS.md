...
* **Bietet die App Nutzern eine Möglichkeit, die Löschung ihrer Daten zu beantragen?** &rarr; **JA** (In-App Account-Löschung + Öffentliches Web-Löschformular unter `https://der-wegweiser.web.app/account-deletion.html`)
